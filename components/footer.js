      ...
      >
        <div className="footer-max-width max-content-container">
          <div className="footer-container">
            <img
              alt="image"
              src="/playground_assets/stt-200h.png"
          ...
          <div className="footer-links">
            <div className="footer-container2">
              ...
              <span className="footer-link">Fale conosco</span>
              <a
              ...
              <Link href="/politica-de-privacidade">
                <a className="footer-link1 footer-link">
            ...
            <div className="footer-container3">
              <span className="footer-text07">Serviços</span>
              <span className="footer-link">Marketing completo</span>
              <span className="footer-link">Assessoria de negócios</span>
            </div>
          </div>
        </div>
      </footer>
...
Footer.defaultProps = {
  rootClassName: '',
  papel: 'TORNE-SE UM EMPREENDEDORª DE VERDADE',
}
