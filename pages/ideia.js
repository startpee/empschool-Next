...
const Ideia = (props) => {
  return (
    <>
      <div className="ideia-container">
        <Head>
          <title>
            ideia - Startpee: Start para Começar o Seu Próprio Negócio
          </title>
          <meta
            name="description"
          ...
          <meta
            property="og:title"
            content="ideia - Startpee: Start para Começar o Seu Próprio Negócio"
          />
          <meta
...
<div class="wistia_responsive_padding" style="padding:56.25% 0 0 0;position:relative;">
    <div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;">
        ...
        <button className="ideia-button button">Continuar</button>
      </div>
      <style jsx>
        {`
          .ideia-container {
