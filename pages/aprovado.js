...
const Aprovado = (props) => {
  return (
    <>
      <div className="aprovado-container">
        <Head>
          <title>
            aprovado - Startpee: Start para Começar o Seu Próprio Negócio
          </title>
          <meta
            name="description"
          ...
          <meta
            property="og:title"
            content="aprovado - Startpee: Start para Começar o Seu Próprio Negócio"
          />
          <meta
